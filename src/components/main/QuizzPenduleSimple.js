...
import simplePendule from '../../resources/penduleSimple.png';
    ...
    return (
      <>
        <div className='penduleElastiqueRoot'>
          <h3>Quizz sur le Pendule Simple</h3>
          <div className='animationSVG'>
            <img src={simplePendule} alt="System a etirer" />
          </div>
          <p>
...
const mapStateToProps = state => ({
  answers: state.penduleSimpleAnswers.simple
});
